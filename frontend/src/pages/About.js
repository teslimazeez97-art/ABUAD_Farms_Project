    ...
    <div style={{ background: "#f9fafb", minHeight: "100vh" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 30, maxWidth: 1000, margin: "60px auto", padding: "0 20px" }}>
        <div style={{ background: "white", padding: 30, borderRadius: 12, boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
          <h3 style={{ fontSize: "1.5rem", color: "#2f855a", marginBottom: 12 }}><FaEye style={{ marginRight: 8 }} /> Our Vision</h3>
        ...
        <div style={{ background: "white", padding: 30, borderRadius: 12, boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
          <h3 style={{ fontSize: "1.5rem", color: "#2f855a", marginBottom: 12 }}><FaBullseye style={{ marginRight: 8 }} /> Our Mission</h3>
          <p style={{ lineHeight: 1.7, color: "#374151" }}>
      ...
      <section style={{ maxWidth: 1000, margin: "60px auto", padding: "0 20px" }}>
        ...
        <ul style={{ listStyle: "none", padding: 0, fontSize: "1.1rem", color: "#374151", lineHeight: 1.8 }}>
          <li style={{ display: "flex", gap: 10, alignItems: "center" }}><FaCheckCircle color="#10b981" /> Excellence in agricultural research and production</li>
          <li style={{ display: "flex", gap: 10, alignItems: "center" }}><FaCheckCircle color="#10b981" /> Integrity and sustainability in operations</li>
          <li style={{ display: "flex", gap: 10, alignItems: "center" }}><FaCheckCircle color="#10b981" /> Student empowerment and skill development</li>
          <li style={{ display: "flex", gap: 10, alignItems: "center" }}><FaCheckCircle color="#10b981" /> Commitment to food security and community growth</li>
        </ul>
      </section>
